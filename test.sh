...
config_dir="all_models/fine_tuned" # path to folders with models to evaluate

output_file="all_models/evaluation_results.csv"
...
base_line_dir="all_models"
output_file="all_models/baseline_evaluation_results.csv"
