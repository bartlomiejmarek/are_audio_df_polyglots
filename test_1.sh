...
config_dir="all_models/all_models_1/fine_tuned" # path to folders with models to evaluate

output_file="all_models/all_models_1/evaluation_results.csv"
...
base_line_dir="all_models/all_models_1"
output_file="all_models/all_models_1/baseline_evaluation_results.csv"
