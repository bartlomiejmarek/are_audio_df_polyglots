...
config_dir="all_models/all_models_2/fine_tuned" # path to folders with models to evaluate

output_file="all_models/all_models_2/evaluation_results.csv"
...
base_line_dir="all_models/all_models_2"
output_file="all_models/all_models_2/baseline_evaluation_results.csv"
